    ...
    <div class="d-flex align-items-center position-relative height-lg-100vh">
        <div class="login-form-block bg-white col-lg-6 col-xl-6 col-md-12 col-sm-12 col-12 d-lg-flex  align-items-center  height-lg-100vh ">
            <div class="w-100">
                ...
                <h2 class="font-weight-bold m-b-10">Inicio de sesión</h2>
                ...
                <form id="login_form" action="<?php echo base_url(); ?>login/check_login" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <div style="margin-bottom: 15px;">
                        <input type="checkbox" checked="checked" name="remember" id="remember"><label for="remember">Recordar</label>
                        <a href="<?php echo base_url(); ?>forgot-password" style="float: right;">¿Olvido su contraseña?</a>
                    </div>
                    <button type="submit" class="btn btn-brand btn-block btn-lg">Iniciar sesión</button>
                </form>
                ...
                <div class="row" style="padding:0 10px 20px 15px; ">
                    ...
                    <a href="<?php echo base_url(); ?>register" class="btn btn-brand btn-block btn-lg">Registrarse</a>
                    </div>
                    </div>
                    <div class="row" style="padding-left:15px; ">
                        ...
                        <div class="col-lg-6">
                            <a href="<?php echo base_url(); ?>" class="btn btn-outline-light btn-block btn-lg">Atrás</a>
                        </div>
                    </div>                
            </div>
        </div>
