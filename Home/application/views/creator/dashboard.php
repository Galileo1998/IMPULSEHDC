...
<div class="row" style="background-color:#ffee54; color:#000; padding: 10px;">
  <div class="col-12" style=" text-align: center;">
    <p>Complete el nombre de la campaña y otros detalles antes de publicar sus videos..</p>
  </div>
</div>
<div class="container p-b-80">
	<div class="row">
        ...
        data-toggle="tooltip" title="Haga clic en la imagen para cargar una nueva imagen de perfile"
      ...
      <script type="text/javascript">                
        ...
        function handleServerError(error, defaultError) {
                        ...
                        if (result.value) {
                          ...
                          $.get('<?php echo base_url(); ?>upload/delete_profile_image',function(res){
                            ...
                            swal({
                              type: 'error',
                              title: 'Oops...',
                              text: '¡Aún no tienes una imagen de perfil!'                        
                            });
                          }
                  ...
                  <div class="dct-dash-details">
                   ...
                   <p class="year"> <?php echo 'De '.$user['year']; ?></p>
                   ...
                   <div class="row m-t-30 collapse"  id="demo">
                    <form action="<?php echo base_url(); ?>dashboard/update_profile" method="post" id="profile_form">                                       						
                      <div class="col-md-12 m-t-10">
                       <input type="text" placeholder="Nombres" class="input-pay" id="first_name" value="<?php echo $user['first_name'] ?>" name="first_name" >

                       <input type="text" placeholder="Apellidos" class="input-pay" id="last_name" value="<?php echo $user['last_name'] ?>" name="last_name" >
                     </div>
                     <div class="col-md-12 m-t-10">
                       <input type="text" placeholder="Nombre del Canal" class="input-pay" id="channel_name" value="<?php echo $user['name'] ?>" name="channel_name" required>
                     </div>
                     <div class="col-md-12 m-t-10">
                       <select name="year" id="year" class="input-pay" >
                        <option value="">Año de inicio de la campaña</option>    
                        <?php 
                  ...
                  <div class="col-md-12 m-t-10">
                   <textarea cols="30" rows="4" class="form-control" id="description"placeholder="Ingresar descripción" name="description"><?php echo !empty($user['description'])?$user['description']:'Hi, I am using BoostZone Platform. Checkout my new videos here!'; ?></textarea>
                 </div>
                                        <!-- <div class="col-md-12 m-t-10">
                                            <input type="text" value="Change Email Address" class="input-pay" >
                                          </div> -->
                                          <div class="col-md-12 m-t-10">
                                           <input type="password" placeholder="Cambiar contraseña" class="input-pay" id="password" name="password" onkeyup="validatePassword(this.value);">
                                           <span id="msg"></span>
                                         </div>
                 
                                         <div class="col-md-12 m-t-10">
                                           <input type="password" placeholder="Confirmar contraseña" class="input-pay" id="confirm_password" name="confirm_password">
                                         </div>
                                         <div class="col-md-12 m-t-10">
                                           <input type="text" placeholder="Cambiar número de teléfono" class="input-pay" name="mobile_no" value="<?php echo $user['mobile_no']; ?>">
                                         </div>
                                         <div class="col-md-12 m-t-10">
                                           <input type="text" placeholder="Nombre del banco" class="input-pay" name="bank_name" value="<?php echo $user['bank_name']; ?>">
                                         </div>
                                         <div class="col-md-12 m-t-10">
                                           <input type="text" placeholder="Número de cuenta" class="input-pay" name="account_no" value="<?php echo $user['account_no']; ?>">
                                         </div>
                                         <div class="col-md-12 m-t-10">
                                           <input type="text" placeholder="Código IFSC" class="input-pay" name="ifsc_code" value="<?php echo $user['ifsc_code']; ?>">
                                         </div>
                                     ...
                                     <div class="dct-dash-details">
                                       <a href="#" class="btn btn-brand btn-sm" data-toggle="collapse" data-target="#demo">Editar perfil</a>
                                     </div>
                                   </div>
                                 </div>
                               </div>
                                ...
                                <form action="<?php echo base_url(); ?>dashboard/add_video" method="post">
                                  <div class="row">
                                    <div class="col-lg-6 col-md-6 ">
                                      <input type="text" placeholder="Coloca tu video promocional aquí" class="input-pay m-t-10" name="videos[]" value="" id="video_id" required> 
                                    </div>    
                                 ...
                                 <div class="col-lg-3 col-md-6 dct-dash-details">
                                  <button type="submit" value="Submit">Añadir Video</button>
                                </div>
                              </div>
                          ...
                          <div class="tab-regular">                    	
                            <div class="tab-content" id="myTabContent7" style="padding: 0px !important;">
                              <h3 class="p-t-30 p-b-10">Lista de donantes recientes</h3>
