                ...
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <div class="card-footer">
                                <h3 class="card-title mb-0">Buscadores de ayuda</h3>
                            </div>
                            ...
                            <!-- <a href="javascript:void(0)" data-toggle="tooltip" title="" class="btn btn-effect-ripple btn-xs btn-success" style="overflow: hidden; position: relative;" data-original-title="Edit User"><i class="fa fa-edit"></i></a>
                             -->
                            <div class="card-footer">
                                <a href="<?php echo base_url(); ?>creators">Mirar todos los buscadores de ayuda</a>
                            </div>
                       
                    </div>
                    <div class="col-md-6">
                            <div class="card-footer">
                                <h3 class="card-title mb-0">Donadores</h3>
                            </div>
                            <div class="card hero-slide-nineteen-table aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                                <div class="table-responsive">  
                                    <table class="table">
                            ...
                            <div class="card-footer">
                                <a href="<?php echo base_url(); ?>donators">Mirar todos los donadores</a>
                            </div>
