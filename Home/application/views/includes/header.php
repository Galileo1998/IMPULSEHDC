                        ...
                        <div class="collapse navbar-collapse" id="navbar-transparent">
                            ...
                            <?php if(empty($this->session->userdata('user_id'))){ ?>
                                <div class="header-btn">
                                    <a href="<?php echo base_url(); ?>register" class="btn btn-brand btn-sm">Registrarse</a>
                                </div>
                            <?php }else{ ?> 
                                <div class="header-btn">
                                    <a href="<?php echo base_url(); ?>dashboard" class="btn btn-brand btn-sm">Panel principal</a>
                                </div>
                            <?php } ?>
                            <div class="searchbar">
                                <input class="search_input" type="text" name="" placeholder="Buscar..." id="search" style="margin-top: 7px;
                                padding: 2px 10px;
                                width: 100px;
                                caret-color: red;
