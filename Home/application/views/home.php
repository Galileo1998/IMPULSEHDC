            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="hero-slide-seventeen-caption" data-aos="fade-up">
                        <h1 class="hero-slide-seventeen-caption-title2">El principio que me guía<br>
                        <h1 class="hero-slide-seventeen-caption-title2">es que la prosperidad se puede compartir.</h1></h1>
                        <p class="hero-slide-seventeen-caption-text"> Impulse, una plataforma crowdfunding.</p>
                        <div class="row">
                            <div class="col-md-6 ">
                                <a href="<?php echo base_url(); ?>login" class="btn btn-secondary btn-lg btn-block ">Buscador de ayuda</a></div>
                            <div class="col-md-6 hea-t-20">
                                <a href="<?php echo base_url(); ?>login" class="btn btn-white btn-lg btn-block">Donante</a></div>
                        </div>
                    </div>
                    <!-- pagecaption close -->
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="https://Boostzone.xyz/login">Iniciar sesión</a></li>
                            <li><a href="https://Boostzone.xyz/register">Registrarse</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled ">
                            <li><a href="https://Boostzone.xyz">Principal</a></li>
                            <li><a href="https://Boostzone.xyz/about-us">Acerca de</a></li>
                            <li><a href="https://Boostzone.xyz/contact">Contacto</a></li>
                        </ul>
                    </div>
                </div>
                <!-- /.footer-widget -->
